...
private:
    ...
    {
        return {{hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<0>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<1>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<2>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<3>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<4>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<5>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<6>(e) & hash_mask,
                 hash_function.GRS_TEMPLATE_OPERATOR_PREFIX operator()<7>(e) & hash_mask}};
    }
