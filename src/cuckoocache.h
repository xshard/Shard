...
//XSD
#ifdef _MSC_VER
#	define XSD_TEMPLATE_OPERATOR_PREFIX
#else
#	define XSD_TEMPLATE_OPERATOR_PREFIX template
#endif
...
private:
    ...
    {
        return {{hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<0>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<1>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<2>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<3>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<4>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<5>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<6>(e) & hash_mask,
                 hash_function.XSD_TEMPLATE_OPERATOR_PREFIX operator()<7>(e) & hash_mask}};
    }
