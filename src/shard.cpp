...
// Copyright (c) 2014-2015 The Shard developers
...
//
static const int64_t nTargetSpacing = 1 * 60; // shard every 60 seconds
...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward) {
	const char* pszTimestamp = "Sheriff says he got 23 calls about shooter's family, but records show more";
...
public:
    CMainParams() {
		...
		genesis = CreateGenesisBlock(1519722675, 220035, 0x1e0fffff, 112, 0);
		...
		*/
		...
		assert(consensus.hashGenesisBlock == uint256S("0x4892b868074c36d2afae175b1628cc21b3f5c4b6ef7590b7ce876ecfa5a17e52"));
		assert(genesis.hashMerkleRoot == uint256S("0x9cf5470a15f9d71f9a7a03a06d9069613cb229292c2b03648d71d32f261bae68"));
        ...
        checkpointData = (CCheckpointData){
            ...
            (1519722675, uint256S("0x4892b868074c36d2afae175b1628cc21b3f5c4b6ef7590b7ce876ecfa5a17e52")),
            0,
            0,
            0
        };
...
/*!!!R		for (int nonce=1; nonce < 0x7FFFFFFF; ++nonce) {
		...
		*/
        ...
        fMiningRequiresPeers = false;			//XSD  Testnet can have single node
        fDefaultConsistencyChecks = false;
...
{
//XSD	regTestParams.UpdateBIP9Parameters(d, nStartTime, nTimeout);
}
