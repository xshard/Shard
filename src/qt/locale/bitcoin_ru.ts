...
<context>
    ...
    <message>
        ...
        <translation>К bitcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть GroestlCoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
for example: alertnotify=echo %%s | mail -s "GroestlCoin Alert" admin@foo.com
        ...
        <translation>Для использования bitcoind или опции groestlcoin-qt -server, вы должны установить опцию rpcpassword в конфигурационном файле:
 %s
